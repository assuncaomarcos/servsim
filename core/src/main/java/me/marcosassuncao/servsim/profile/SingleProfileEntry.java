...
public class SingleProfileEntry extends ProfileEntry {
     ...
     */
    public SingleProfileEntry(final long time) {
        super(time);
        ranges = null;
    }
     ...
     */
    public void setAvailRanges(final RangeList availRanges) {
        ranges = availRanges;
    }
     ...
     * @return <code>true</code> if the ranges changed as
     * result of this call
     */
    public boolean addRanges(final RangeList list) {
     ...
     */
    public SingleProfileEntry clone(final long time) {
        return new SingleProfileEntry(time, ranges == null
                ? null
                : ranges.clone());
    }
}
