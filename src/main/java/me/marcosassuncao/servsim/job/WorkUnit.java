...
public interface WorkUnit {
    ...
    enum Status implements StateTransition<Status> {
        ...
        /**
         * The unit's status is unknown (the default when
         * the unit is created).
         */
        UNKNOWN(List.of()),

        /**
         * The unit arrived at the server, but has not been processed
         * by the scheduler yet.
         */
        ENQUEUED(List.of(UNKNOWN)),

        /**
         * The unit has been submitted and is waiting to be
        ...
        /**
         * Preconditions for changing the work unit's state
         * (states it must be at present to allow a change to
         * the next state).
         */
        private final List<Status> conditions;

        Status(final List<Status> conditions) {
