...
public class JobActivity {
	 ...
	 */
	public void setResumeOverhead(long time) {
	 ...
	 * @return the start time of the activity or {@link WorkUnit#TIME_NOT_SET} if it is unknown.
	 */
	 ...
	 * @return the finish time of the activity or {@link WorkUnit#TIME_NOT_SET} if it is unknown.
	 */
	...
	public String toString() {
		return MoreObjects.toStringHelper(this)
			    .add("resources", rangeList == null ? "[]" : rangeList.toString())
