...
public class Reservation extends DefaultWorkUnit {
    /**
     * The start time required for the reservation.
     */
    private final long reqStartTime;

    /**
     * A specific range of resources required.
     */
     ...
     */
    public Reservation(final long startTime,
            final long duration, final int numResources) {
        super(duration);
    ...
    /**
     * Creates a String representation of the reservation.
