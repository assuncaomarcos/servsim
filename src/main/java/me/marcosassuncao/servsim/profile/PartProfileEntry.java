...
public class PartProfileEntry extends ProfileEntry {
	 ...
	 */
	public PartProfileEntry(long time, int numPart) {
		super(time);
	 ...
	 * 			out of the bounds.
	 */
	public RangeList getAvailRanges(int partId) {
	 ...
	 * 			out of the bounds.
	 */
	public void setAvailRanges(int partId, RangeList availRanges) {
		checkElementIndex(partId, rangesParts.length, 
				"Partition " + partId + " does not exist");
	 ...
	 * 			out of the bounds.
	 */
	public void addRanges(int partId, RangeList list) {
		checkElementIndex(partId, rangesParts.length, 
				"Partition " + partId + " does not exist");
	 ...
	 * @return the number of PEs
	 */
	public int getNumResources(int partId) {
		checkElementIndex(partId, rangesParts.length, 
				"Partition " + partId + " does not exist");
		return rangesParts[partId] == null ? 0 : rangesParts[partId].getNumItems();
	}
	 ...
	 */
	@Override
	public PartProfileEntry clone(long time) {
	 ...
	 * @see RangeList
	 */
	private class PrivResourceRangeList extends RangeList {
		 ...
		 */
		@Override
		public boolean addAll(RangeList rl) {
			throw new UnsupportedOperationException();
		}
	}
}
