 ...
 * a delegation of {@link me.marcosassuncao.servsim.profile.SingleProfile}.
 *
 * @author Marcos Dias de Assuncao
 */
public abstract class ResourcePool extends SimEntity {
    /** Listeners registered to resource changes. */
    private ArrayList<ResourceStatusListener> listeners;

    /**
     * The maximum capacity of this resource pool.
     */
     ...
     */
    public ResourcePool(final int capacity) {
     ...
     */
    public boolean addResourceStatusListener(
            final ResourceStatusListener listener) {
     ...
     * @return <code>true</code> if successful
     */
    public boolean removeResourceStatusListener(
            final ResourceStatusListener listener) {
     ...
     */
    public abstract ProfileEntry checkAvailability(int numRes,
                                                   long startTime,
                                                   long duration);
     ...
     * @param startTime the start time of the job/reservation
     * @param duration the duration of the job/reservation
     * @param flexible defines whether less resources
     *                 than originally requested is allowed
     * @return a {@link ProfileEntry} with the start time provided and the
     * ranges available at that time OR <code>null</code>
     * if not enough resources are found.
     */
     ...
     * @param startTime the start time of the job/reservation
     */
    public abstract void allocateResources(WorkUnit task,
                                           RangeList resources,
                                           long startTime);
     ...
     */
    public abstract void allocateResources(RangeList selected,
                                           long startTime,
                                           long finishTime);
     ...
     */
    public abstract boolean releaseResources(long startTime,
                                             long finishTime,
                                             RangeList list);
